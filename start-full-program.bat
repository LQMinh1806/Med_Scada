...
start "" /B powershell -NoProfile -ExecutionPolicy Bypass -File "scripts\open-ui-browser.ps1" -Url "http://192.168.0.123:5173/" -Port 5173 -PidFile ".runtime\browser.pid"
